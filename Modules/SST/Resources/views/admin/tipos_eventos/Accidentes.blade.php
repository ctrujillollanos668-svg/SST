    ...
    <div class="bg-white p-6 sm:p-7 rounded-2xl border border-slate-200/80 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4 transition-all duration-200">
        ...
        <div class="flex items-center gap-3">
            <button onclick="openRegisterModal()" class="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-orange-600 hover:bg-orange-700 active:bg-orange-800 text-white text-sm font-bold shadow-xs transition-all duration-200 cursor-pointer group border border-orange-500/80">
                ...
                <span>Registrar Tipo de Accidentes</span>
            </button>
        </div>
    </div>
                ...
                <tbody class="divide-y divide-slate-100 text-slate-700 text-sm font-medium">
                    ...
                    <tr class="hover:bg-slate-50/60 transition-colors">
                        ...
                        <td class="py-4 px-6 text-slate-600 max-w-md">
                            <p class="line-clamp-2 cursor-pointer hover:text-orange-600 transition-colors" onclick="showFullDesc(event, 'Accidentes ocurridos durante trabajos en andamios, escaleras, tejados o plataformas elevadas donde el trabajador sufre una precipitación hacia un nivel inferior, pudiendo causar politraumatismos severos.')" title="Haz clic para ver la descripción completa">
                                Accidentes ocurridos durante trabajos en andamios, escaleras, tejados o plataformas elevadas donde el trabajador sufre una precipitación hacia un nivel inferior, pudiendo causar politraumatismos severos.
                            </p>
                        </td>
                        ...
                        <td class="py-4 px-6 text-center whitespace-nowrap">
                            <div class="flex items-center justify-center gap-2">
                                <button onclick="openEditModal('Caída de altura', 'Accidentes ocurridos durante trabajos en andamios, escaleras, tejados o plataformas elevadas donde el trabajador sufre una precipitación hacia un nivel inferior, pudiendo causar politraumatismos severos.')" class="w-9 h-9 rounded-xl bg-amber-50 hover:bg-amber-100 text-amber-600 border border-amber-200/80 flex items-center justify-center transition-all duration-150 cursor-pointer shadow-xs hover:scale-105" title="Editar">
                                    <i class="fa-regular fa-pen-to-square text-sm"></i>
                                </button>
                                <button onclick="openDeleteModal('Caída de altura')" class="w-9 h-9 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200/80 flex items-center justify-center transition-all duration-150 cursor-pointer shadow-xs hover:scale-105" title="Eliminar">
                    ...
                    <tr class="hover:bg-slate-50/60 transition-colors">
                        ...
                        <td class="py-4 px-6 text-slate-600 max-w-md">
                            <p class="line-clamp-2 cursor-pointer hover:text-orange-600 transition-colors" onclick="showFullDesc(event, 'Introducción de extremidades o indumentaria dentro de piezas de maquinaria activa, engranajes, fajas o rodillos en movimiento por falta de guardas de protección.')" title="Haz clic para ver la descripción completa">
                                Introducción de extremidades o indumentaria dentro de piezas de maquinaria activa, engranajes, fajas o rodillos en movimiento por falta de guardas de protección.
                            </p>
                        </td>
                        <td class="py-4 px-6 text-center whitespace-nowrap">
                            <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-emerald-50 text-emerald-700 border border-emerald-200/80">
                        ...
                        <td class="py-4 px-6 text-center whitespace-nowrap">
                            <div class="flex items-center justify-center gap-2">
                                <button onclick="openEditModal('Atrapamiento', 'Introducción de extremidades o indumentaria dentro de piezas de maquinaria activa, engranajes, fajas o rodillos en movimiento por falta de guardas de protección.')" class="w-9 h-9 rounded-xl bg-amber-50 hover:bg-amber-100 text-amber-600 border border-amber-200/80 flex items-center justify-center transition-all duration-150 cursor-pointer shadow-xs hover:scale-105" title="Editar">
                                    <i class="fa-regular fa-pen-to-square text-sm"></i>
                                </button>
                                <button onclick="openDeleteModal('Atrapamiento')" class="w-9 h-9 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200/80 flex items-center justify-center transition-all duration-150 cursor-pointer shadow-xs hover:scale-105" title="Eliminar">
                                    <i class="fa-regular fa-trash-can text-sm"></i>
                                </button>
                            </div>
                        </td>
                    ...
                    <tr class="hover:bg-slate-50/60 transition-colors">
                        ...
                        <td class="py-4 px-6 text-slate-600 max-w-md">
                            <p class="line-clamp-2 cursor-pointer hover:text-orange-600 transition-colors" onclick="showFullDesc(event, 'Lesiones provocadas por manipulación insegura de instrumentos cortantes, sierras, martillos o materiales punzantes durante la jornada de trabajo.')" title="Haz clic para ver la descripción completa">
                                Lesiones provocadas por manipulación insegura de instrumentos cortantes, sierras, martillos o materiales punzantes durante la jornada de trabajo.
                            </p>
                        </td>
                        <td class="py-4 px-6 text-center whitespace-nowrap">
                            <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-emerald-50 text-emerald-700 border border-emerald-200/80">
                        ...
                        <td class="py-4 px-6 text-center whitespace-nowrap">
                            <div class="flex items-center justify-center gap-2">
                                <button onclick="openEditModal('Golpes o cortes con herramientas', 'Lesiones provocadas por manipulación insegura de instrumentos cortantes, sierras, martillos o materiales punzantes durante la jornada de trabajo.')" class="w-9 h-9 rounded-xl bg-amber-50 hover:bg-amber-100 text-amber-600 border border-amber-200/80 flex items-center justify-center transition-all duration-150 cursor-pointer shadow-xs hover:scale-105" title="Editar">
                                    <i class="fa-regular fa-pen-to-square text-sm"></i>
                                </button>
                                <button onclick="openDeleteModal('Golpes o cortes con herramientas')" class="w-9 h-9 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200/80 flex items-center justify-center transition-all duration-150 cursor-pointer shadow-xs hover:scale-105" title="Eliminar">
                                    <i class="fa-regular fa-trash-can text-sm"></i>
                                </button>
                            </div>
                        </td>
                    ...
                    <tr class="hover:bg-slate-50/60 transition-colors">
                        ...
                        <td class="py-4 px-6 text-slate-600 max-w-md">
                            <p class="line-clamp-2 cursor-pointer hover:text-orange-600 transition-colors" onclick="showFullDesc(event, 'Descargas o arcos eléctricos por intervención directa o indirecta con tableros energizados desprotegidos, cables expuestos o herramientas defectuosas.')" title="Haz clic para ver la descripción completa">
                                Descargas o arcos eléctricos por intervención directa o indirecta con tableros energizados desprotegidos, cables expuestos o herramientas defectuosas.
                            </p>
                        </td>
                        <td class="py-4 px-6 text-center whitespace-nowrap">
                            <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-emerald-50 text-emerald-700 border border-emerald-200/80">
                        ...
                        <td class="py-4 px-6 text-center whitespace-nowrap">
                            <div class="flex items-center justify-center gap-2">
                                <button onclick="openEditModal('Contacto eléctrico', 'Descargas o arcos eléctricos por intervención directa o indirecta con tableros energizados desprotegidos, cables expuestos o herramientas defectuosas.')" class="w-9 h-9 rounded-xl bg-amber-50 hover:bg-amber-100 text-amber-600 border border-amber-200/80 flex items-center justify-center transition-all duration-150 cursor-pointer shadow-xs hover:scale-105" title="Editar">
                                    <i class="fa-regular fa-pen-to-square text-sm"></i>
                                </button>
                                <button onclick="openDeleteModal('Contacto eléctrico')" class="w-9 h-9 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200/80 flex items-center justify-center transition-all duration-150 cursor-pointer shadow-xs hover:scale-105" title="Eliminar">
                                    <i class="fa-regular fa-trash-can text-sm"></i>
                                </button>
                            </div>
                        </td>
...
<div id="modalRegister" class="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center hidden p-4">
    <div class="bg-white rounded-2xl shadow-xl border border-slate-100 w-full max-w-lg overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <form onsubmit="handleModalSubmit(event, 'Tipo de accidente registrado con éxito')">
            <div class="p-6 space-y-4 text-xs">
                <div>
                    <label class="block font-bold text-slate-700 mb-1.5">Nombre del Tipo de Accidente *</label>
                    <input type="text" required placeholder="Ej. Quemaduras químicas" class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-100 transition text-sm">
                </div>
                <div>
                    <label class="block font-bold text-slate-700 mb-1.5">Descripción *</label>
                    <textarea rows="3" required placeholder="Describa el alcance de este tipo de accidente..." class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-100 transition text-sm"></textarea>
                </div>
                <div>
...
<div id="modalEdit" class="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center hidden p-4">
    <div class="bg-white rounded-2xl shadow-xl border border-slate-100 w-full max-w-lg overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <form onsubmit="handleModalSubmit(event, 'Tipo de accidente actualizado con éxito')">
            <div class="p-6 space-y-4 text-xs">
                <div>
                    <label class="block font-bold text-slate-700 mb-1.5">Nombre del Tipo de Accidente *</label>
