...
@section('title', 'Tipos de Eventos - Incidentes • SST')
...
<div class="space-y-6 max-w-7xl mx-auto">
    ...
    <div class="bg-white p-6 sm:p-7 rounded-2xl border border-slate-200/80 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4 transition-all duration-200">
        <div class="flex items-center gap-3.5">
            ...
            <div>
                <h1 class="text-2xl font-extrabold text-slate-900 tracking-tight">Tipos de Incidentes</h1>
        ...
        <div class="flex items-center gap-3">
            <button onclick="openRegisterModal()" class="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-orange-50 hover:bg-orange-100/80 active:bg-orange-200/70 text-orange-700 text-sm font-bold shadow-xs transition-all duration-200 cursor-pointer group border border-orange-200/90 hover:border-orange-300">
                ...
                <span>Registrar Tipo de Incidentes</span>
            </button>
        </div>
    </div>
                ...
                <tbody class="divide-y divide-slate-100 text-slate-700 text-sm font-medium">
                    ...
                    <tr class="hover:bg-slate-50/60 transition-colors">
                        <td class="py-4 px-6 font-bold text-slate-900 break-words">
                            Casi caída por piso húmedo
                        </td>
                        <td class="py-4 px-6 text-slate-600 max-w-md">
                            <p class="line-clamp-2 cursor-pointer hover:text-orange-600 transition-colors" onclick="showFullDesc(event, 'Resbalón o pérdida temporal del equilibrio en pasillos o áreas de alto tránsito debido a derrames o aseo sin señalización, sin llegar a impactar directamente contra el suelo.')" title="Haz clic para ver la descripción completa">
                                Resbalón o pérdida temporal del equilibrio en pasillos o áreas de alto tránsito debido a derrames o aseo sin señalización, sin llegar a impactar directamente contra el suelo.
                            </p>
                        </td>
                        ...
                        <td class="py-4 px-6 text-center whitespace-nowrap">
                            <div class="flex items-center justify-center gap-2">
                                <button onclick="openEditModal('Casi caída por piso húmedo', 'Resbalón o pérdida temporal del equilibrio en pasillos o áreas de alto tránsito debido a derrames o aseo sin señalización, sin llegar a impactar directamente contra el suelo.')" class="w-9 h-9 rounded-xl bg-amber-50 hover:bg-amber-100 text-amber-600 border border-amber-200/80 flex items-center justify-center transition-all duration-150 cursor-pointer shadow-xs hover:scale-105" title="Editar">
                                    <i class="fa-regular fa-pen-to-square text-sm"></i>
                                </button>
                                <button onclick="openDeleteModal('Casi caída por piso húmedo')" class="w-9 h-9 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200/80 flex items-center justify-center transition-all duration-150 cursor-pointer shadow-xs hover:scale-105" title="Eliminar">
                    ...
                    <tr class="hover:bg-slate-50/60 transition-colors">
                        <td class="py-4 px-6 font-bold text-slate-900 break-words">
                            Derrame menor de líquidos
                        </td>
                        <td class="py-4 px-6 text-slate-600 max-w-md">
                            <p class="line-clamp-2 cursor-pointer hover:text-orange-600 transition-colors" onclick="showFullDesc(event, 'Fuga o vertido accidental de sustancias en áreas de trabajo que fue controlado inmediatamente con kits de goteo y no generó quemaduras ni afectaciones a la salud.')" title="Haz clic para ver la descripción completa">
                                Fuga o vertido accidental de sustancias en áreas de trabajo que fue controlado inmediatamente con kits de goteo y no generó quemaduras ni afectaciones a la salud.
                            </p>
                        </td>
                        <td class="py-4 px-6 text-center whitespace-nowrap">
                            <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-emerald-50 text-emerald-700 border border-emerald-200/80">
                        ...
                        <td class="py-4 px-6 text-center whitespace-nowrap">
                            <div class="flex items-center justify-center gap-2">
                                <button onclick="openEditModal('Derrame menor de líquidos', 'Fuga o vertido accidental de sustancias en áreas de trabajo que fue controlado inmediatamente con kits de goteo y no generó quemaduras ni afectaciones a la salud.')" class="w-9 h-9 rounded-xl bg-amber-50 hover:bg-amber-100 text-amber-600 border border-amber-200/80 flex items-center justify-center transition-all duration-150 cursor-pointer shadow-xs hover:scale-105" title="Editar">
                                    <i class="fa-regular fa-pen-to-square text-sm"></i>
                                </button>
                                <button onclick="openDeleteModal('Derrame menor de líquidos')" class="w-9 h-9 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200/80 flex items-center justify-center transition-all duration-150 cursor-pointer shadow-xs hover:scale-105" title="Eliminar">
                                    <i class="fa-regular fa-trash-can text-sm"></i>
                                </button>
                            </div>
                        </td>
                    ...
                    <tr class="hover:bg-slate-50/60 transition-colors">
                        <td class="py-4 px-6 font-bold text-slate-900 break-words">
                            Caída de objetos sin impacto a personas
                        </td>
                        <td class="py-4 px-6 text-slate-600 max-w-md">
                            <p class="line-clamp-2 cursor-pointer hover:text-orange-600 transition-colors" onclick="showFullDesc(event, 'Desprendimiento involuntario de herramientas o cajas desde repisas elevadas que cayeron sobre áreas delimitadas sin golpear ni causar lesiones al personal circundante.')" title="Haz clic para ver la descripción completa">
                                Desprendimiento involuntario de herramientas o cajas desde repisas elevadas que cayeron sobre áreas delimitadas sin golpear ni causar lesiones al personal circundante.
                            </p>
                        </td>
                        <td class="py-4 px-6 text-center whitespace-nowrap">
                            <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-emerald-50 text-emerald-700 border border-emerald-200/80">
                        ...
                        <td class="py-4 px-6 text-center whitespace-nowrap">
                            <div class="flex items-center justify-center gap-2">
                                <button onclick="openEditModal('Caída de objetos sin impacto a personas', 'Desprendimiento involuntario de herramientas o cajas desde repisas elevadas que cayeron sobre áreas delimitadas sin golpear ni causar lesiones al personal circundante.')" class="w-9 h-9 rounded-xl bg-amber-50 hover:bg-amber-100 text-amber-600 border border-amber-200/80 flex items-center justify-center transition-all duration-150 cursor-pointer shadow-xs hover:scale-105" title="Editar">
                                    <i class="fa-regular fa-pen-to-square text-sm"></i>
                                </button>
                                <button onclick="openDeleteModal('Caída de objetos sin impacto a personas')" class="w-9 h-9 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200/80 flex items-center justify-center transition-all duration-150 cursor-pointer shadow-xs hover:scale-105" title="Eliminar">
                                    <i class="fa-regular fa-trash-can text-sm"></i>
                                </button>
                            </div>
                        </td>
                    ...
                    <tr class="hover:bg-slate-50/60 transition-colors">
                        <td class="py-4 px-6 font-bold text-slate-900 break-words">
                            Sobrecarga o chispa en tomacorriente
                        </td>
                        <td class="py-4 px-6 text-slate-600 max-w-md">
                            <p class="line-clamp-2 cursor-pointer hover:text-orange-600 transition-colors" onclick="showFullDesc(event, 'Evento eléctrico imprevisto con destello o chispa al conectar un dispositivo que activó los tacos breakers de protección sin generar amago de incendio ni descargas.')" title="Haz clic para ver la descripción completa">
                                Evento eléctrico imprevisto con destello o chispa al conectar un dispositivo que activó los tacos breakers de protección sin generar amago de incendio ni descargas.
                            </p>
                        </td>
                        <td class="py-4 px-6 text-center whitespace-nowrap">
                            <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-emerald-50 text-emerald-700 border border-emerald-200/80">
                        ...
                        <td class="py-4 px-6 text-center whitespace-nowrap">
                            <div class="flex items-center justify-center gap-2">
                                <button onclick="openEditModal('Sobrecarga o chispa en tomacorriente', 'Evento eléctrico imprevisto con destello o chispa al conectar un dispositivo que activó los tacos breakers de protección sin generar amago de incendio ni descargas.')" class="w-9 h-9 rounded-xl bg-amber-50 hover:bg-amber-100 text-amber-600 border border-amber-200/80 flex items-center justify-center transition-all duration-150 cursor-pointer shadow-xs hover:scale-105" title="Editar">
                                    <i class="fa-regular fa-pen-to-square text-sm"></i>
                                </button>
                                <button onclick="openDeleteModal('Sobrecarga o chispa en tomacorriente')" class="w-9 h-9 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200/80 flex items-center justify-center transition-all duration-150 cursor-pointer shadow-xs hover:scale-105" title="Eliminar">
                                    <i class="fa-regular fa-trash-can text-sm"></i>
                                </button>
                            </div>
                        </td>
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-slate-100 w-full max-w-lg overflow-hidden animate-in fade-in zoom-in duration-200">
        <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
            <h3 class="text-base font-bold text-slate-800 flex items-center gap-2">
                ...
                <span>Registrar Tipo de Incidente</span>
            </h3>
        ...
        <form onsubmit="handleModalSubmit(event, 'Tipo de incidente registrado con éxito')">
            <div class="p-6 space-y-4 text-xs">
                <div>
                    <label class="block font-bold text-slate-700 mb-1.5">Nombre del Tipo de Incidente *</label>
                    <input type="text" required placeholder="Ej. Tropezón con cable suelto" class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-100 transition text-sm">
                </div>
                <div>
                    <label class="block font-bold text-slate-700 mb-1.5">Descripción *</label>
                    <textarea rows="3" required placeholder="Describa el alcance de este tipo de incidente..." class="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-100 transition text-sm"></textarea>
                </div>
                <div>
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-slate-100 w-full max-w-lg overflow-hidden animate-in fade-in zoom-in duration-200">
        <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
            <h3 class="text-base font-bold text-slate-800 flex items-center gap-2">
                ...
                <span>Editar Tipo de Incidente</span>
            </h3>
        ...
        <form onsubmit="handleModalSubmit(event, 'Tipo de incidente actualizado con éxito')">
            <div class="p-6 space-y-4 text-xs">
                <div>
                    <label class="block font-bold text-slate-700 mb-1.5">Nombre del Tipo de Incidente *</label>
...
<div id="modalDelete" class="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center hidden p-4">
    <div class="bg-white rounded-2xl shadow-xl border border-slate-100 w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200">
        <div class="p-6 text-center">
            ...
            <h3 class="text-lg font-bold text-slate-900">¿Eliminar Tipo de Incidente?</h3>
